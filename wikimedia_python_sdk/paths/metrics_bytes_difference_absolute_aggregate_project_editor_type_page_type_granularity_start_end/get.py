...
from wikimedia_python_sdk.model.absolute_bytes_difference import AbsoluteBytesDifference as AbsoluteBytesDifferenceSchema
from wikimedia_python_sdk.model.problem import Problem as ProblemSchema

from wikimedia_python_sdk.type.absolute_bytes_difference import AbsoluteBytesDifference
from wikimedia_python_sdk.type.problem import Problem

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.absolute_bytes_difference import AbsoluteBytesDifference as AbsoluteBytesDifferencePydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = AbsoluteBytesDifferenceSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_absolute_aggregate_by_project_and_date_range_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_absolute_aggregate_by_project_and_date_range_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/bytes-difference/absolute/aggregate/{project}/{editor-type}/{page-type}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_absolute_aggregate_by_project_and_date_range_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAbsoluteAggregateByProjectAndDateRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_absolute_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_absolute_aggregate_by_project_and_date_range_mapped_args(
            project=project,
        ...
        return await self._aget_absolute_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_absolute_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_absolute_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
        )

class GetAbsoluteAggregateByProjectAndDateRange(BaseApi):
    ...
    async def aget_absolute_aggregate_by_project_and_date_range(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_absolute_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
    ...
    def get_absolute_aggregate_by_project_and_date_range(
        ...
        raw_response = self.raw.get_absolute_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
