...
from wikimedia_python_sdk.model.pageview_tops import PageviewTops as PageviewTopsSchema

from wikimedia_python_sdk.type.pageview_tops import PageviewTops
...
from wikimedia_python_sdk.pydantic.pageview_tops import PageviewTops as PageviewTopsPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = PageviewTopsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_most_viewed_articles_by_project_and_timespan_mapped_args(
        self,
        project: str,
        access: str,
        year: str,
    ...
    async def _alist_most_viewed_articles_by_project_and_timespan_oapg(
        self,
    ...
    def _list_most_viewed_articles_by_project_and_timespan_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListMostViewedArticlesByProjectAndTimespanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_most_viewed_articles_by_project_and_timespan(
        self,
        project: str,
        access: str,
        year: str,
        ...
        **kwargs,
        ...
        args = self._list_most_viewed_articles_by_project_and_timespan_mapped_args(
            project=project,
            access=access,
            year=year,
            month=month,
        ...
        return await self._alist_most_viewed_articles_by_project_and_timespan_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_most_viewed_articles_by_project_and_timespan(
        self,
        project: str,
        access: str,
        year: str,
        ...
        return self._list_most_viewed_articles_by_project_and_timespan_oapg(
            path_params=args.path,
        )

class ListMostViewedArticlesByProjectAndTimespan(BaseApi):
    ...
    async def alist_most_viewed_articles_by_project_and_timespan(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_most_viewed_articles_by_project_and_timespan(
            project=project,
            access=access,
            year=year,
            month=month,
    ...
    def list_most_viewed_articles_by_project_and_timespan(
        ...
        raw_response = self.raw.list_most_viewed_articles_by_project_and_timespan(
            project=project,
            access=access,
            year=year,
            month=month,
