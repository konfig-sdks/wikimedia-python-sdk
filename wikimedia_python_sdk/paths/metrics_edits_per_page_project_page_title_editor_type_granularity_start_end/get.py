...
from wikimedia_python_sdk.model.edits_per_page import EditsPerPage as EditsPerPageSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.edits_per_page import EditsPerPage

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.edits_per_page import EditsPerPage as EditsPerPagePydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = EditsPerPageSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_page_edit_counts_mapped_args(
        self,
        project: str,
        page_title: str,
        editor_type: str,
    ...
    async def _aget_page_edit_counts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/edits/per-page/{project}/{page-title}/{editor-type}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_page_edit_counts_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPageEditCountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_page_edit_counts(
        self,
        project: str,
        page_title: str,
        editor_type: str,
        ...
        **kwargs,
        ...
        args = self._get_page_edit_counts_mapped_args(
            project=project,
        ...
        return await self._aget_page_edit_counts_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_page_edit_counts(
        self,
        project: str,
        page_title: str,
        editor_type: str,
        ...
        return self._get_page_edit_counts_oapg(
            path_params=args.path,
        )

class GetPageEditCounts(BaseApi):
    ...
    async def aget_page_edit_counts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_page_edit_counts(
            project=project,
            page_title=page_title,
            editor_type=editor_type,
            granularity=granularity,
    ...
    def get_page_edit_counts(
        ...
        raw_response = self.raw.get_page_edit_counts(
            project=project,
            page_title=page_title,
            editor_type=editor_type,
            granularity=granularity,
