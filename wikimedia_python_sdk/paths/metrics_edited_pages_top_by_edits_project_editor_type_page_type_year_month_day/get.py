...
from wikimedia_python_sdk.model.top_edited_pages_by_edits import TopEditedPagesByEdits as TopEditedPagesByEditsSchema

from wikimedia_python_sdk.type.top_edited_pages_by_edits import TopEditedPagesByEdits
from wikimedia_python_sdk.type.problem import Problem

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.top_edited_pages_by_edits import TopEditedPagesByEdits as TopEditedPagesByEditsPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = TopEditedPagesByEditsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_top_by_edits_count_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_top_by_edits_count_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/edited-pages/top-by-edits/{project}/{editor-type}/{page-type}/{year}/{month}/{day}',
            headers=_headers,
        )
    ...
    def _get_top_by_edits_count_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTopByEditsCountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_by_edits_count(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_top_by_edits_count_mapped_args(
            project=project,
        ...
        return await self._aget_top_by_edits_count_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_top_by_edits_count(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_top_by_edits_count_oapg(
            path_params=args.path,
        )

class GetTopByEditsCount(BaseApi):
    ...
    async def aget_top_by_edits_count(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_top_by_edits_count(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            year=year,
    ...
    def get_top_by_edits_count(
        ...
        raw_response = self.raw.get_top_by_edits_count(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            year=year,
