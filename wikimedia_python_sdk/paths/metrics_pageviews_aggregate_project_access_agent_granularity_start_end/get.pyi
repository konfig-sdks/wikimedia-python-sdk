...
from wikimedia_python_sdk.model.pageview_project import PageviewProject as PageviewProjectSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.pageview_project import PageviewProject

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.pageview_project import PageviewProject as PageviewProjectPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = PageviewProjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_pageview_counts_by_project_mapped_args(
        self,
        project: str,
        access: str,
        agent: str,
    ...
    async def _aget_pageview_counts_by_project_oapg(
        self,
    ...
    def _get_pageview_counts_by_project_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPageviewCountsByProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pageview_counts_by_project(
        self,
        project: str,
        access: str,
        agent: str,
        ...
        **kwargs,
        ...
        args = self._get_pageview_counts_by_project_mapped_args(
            project=project,
            access=access,
            agent=agent,
        ...
        return await self._aget_pageview_counts_by_project_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_pageview_counts_by_project(
        self,
        project: str,
        access: str,
        agent: str,
        ...
        return self._get_pageview_counts_by_project_oapg(
            path_params=args.path,
        )

class GetPageviewCountsByProject(BaseApi):
    ...
    async def aget_pageview_counts_by_project(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pageview_counts_by_project(
            project=project,
            access=access,
            agent=agent,
            granularity=granularity,
    ...
    def get_pageview_counts_by_project(
        ...
        raw_response = self.raw.get_pageview_counts_by_project(
            project=project,
            access=access,
            agent=agent,
            granularity=granularity,
