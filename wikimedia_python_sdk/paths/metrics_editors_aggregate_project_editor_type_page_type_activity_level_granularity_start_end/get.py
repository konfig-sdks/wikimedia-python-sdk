...
from wikimedia_python_sdk.model.editors import Editors as EditorsSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.editors import Editors

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.editors import Editors as EditorsPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = EditorsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_editors_counts_for_project_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_editors_counts_for_project_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/editors/aggregate/{project}/{editor-type}/{page-type}/{activity-level}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_editors_counts_for_project_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetEditorsCountsForProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_editors_counts_for_project(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_editors_counts_for_project_mapped_args(
            project=project,
        ...
        return await self._aget_editors_counts_for_project_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_editors_counts_for_project(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_editors_counts_for_project_oapg(
            path_params=args.path,
        )

class GetEditorsCountsForProject(BaseApi):
    ...
    async def aget_editors_counts_for_project(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_editors_counts_for_project(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            activity_level=activity_level,
    ...
    def get_editors_counts_for_project(
        ...
        raw_response = self.raw.get_editors_counts_for_project(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            activity_level=activity_level,
