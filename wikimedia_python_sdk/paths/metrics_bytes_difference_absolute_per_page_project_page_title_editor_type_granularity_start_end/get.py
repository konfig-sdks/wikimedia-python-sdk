...
from wikimedia_python_sdk.model.absolute_bytes_difference_per_page import AbsoluteBytesDifferencePerPage as AbsoluteBytesDifferencePerPageSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.absolute_bytes_difference_per_page import AbsoluteBytesDifferencePerPage

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.absolute_bytes_difference_per_page import AbsoluteBytesDifferencePerPage as AbsoluteBytesDifferencePerPagePydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = AbsoluteBytesDifferencePerPageSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_absolute_per_page_mapped_args(
        self,
        project: str,
        page_title: str,
        editor_type: str,
    ...
    async def _aget_absolute_per_page_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/bytes-difference/absolute/per-page/{project}/{page-title}/{editor-type}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_absolute_per_page_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAbsolutePerPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_absolute_per_page(
        self,
        project: str,
        page_title: str,
        editor_type: str,
        ...
        **kwargs,
        ...
        args = self._get_absolute_per_page_mapped_args(
            project=project,
        ...
        return await self._aget_absolute_per_page_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_absolute_per_page(
        self,
        project: str,
        page_title: str,
        editor_type: str,
        ...
        return self._get_absolute_per_page_oapg(
            path_params=args.path,
        )

class GetAbsolutePerPage(BaseApi):
    ...
    async def aget_absolute_per_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_absolute_per_page(
            project=project,
            page_title=page_title,
            editor_type=editor_type,
            granularity=granularity,
    ...
    def get_absolute_per_page(
        ...
        raw_response = self.raw.get_absolute_per_page(
            project=project,
            page_title=page_title,
            editor_type=editor_type,
            granularity=granularity,
