...
from wikimedia_python_sdk.model.edited_pages import EditedPages as EditedPagesSchema

from wikimedia_python_sdk.type.edited_pages import EditedPages
from wikimedia_python_sdk.type.problem import Problem

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.edited_pages import EditedPages as EditedPagesPydantic
...
class EditorTypeSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "all-editor-types": "ALLEDITORTYPES",
            "anonymous": "ANONYMOUS",
            "group-bot": "GROUPBOT",
            "name-bot": "NAMEBOT",
            "user": "USER",
...
class ActivityLevelSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "all-activity-levels": "ALLACTIVITYLEVELS",
            "1..4-edits": "_1__4EDITS",
            "5..24-edits": "_5__24EDITS",
            "25..99-edits": "_25__99EDITS",
            "100..-edits": "_100__EDITS",
        }
    
    @schemas.classproperty
    def ALLACTIVITYLEVELS(cls):
        return cls("all-activity-levels")
    
    @schemas.classproperty
    def _1__4EDITS(cls):
        return cls("1..4-edits")
    
    @schemas.classproperty
    def _5__24EDITS(cls):
        return cls("5..24-edits")
    
    @schemas.classproperty
    def _25__99EDITS(cls):
        return cls("25..99-edits")
    
    @schemas.classproperty
    def _100__EDITS(cls):
        return cls("100..-edits")
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'activity-level': typing.Union[ActivityLevelSchema, str, ],
...
request_path_activity_level = api_client.PathParameter(
    name="activity-level",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationProblemjson = EditedPagesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_aggregate_by_project_and_date_range_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_aggregate_by_project_and_date_range_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/edited-pages/aggregate/{project}/{editor-type}/{page-type}/{activity-level}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_aggregate_by_project_and_date_range_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAggregateByProjectAndDateRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_aggregate_by_project_and_date_range_mapped_args(
            project=project,
        ...
        return await self._aget_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
        )

class GetAggregateByProjectAndDateRange(BaseApi):
    ...
    async def aget_aggregate_by_project_and_date_range(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            activity_level=activity_level,
    ...
    def get_aggregate_by_project_and_date_range(
        ...
        raw_response = self.raw.get_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            activity_level=activity_level,
