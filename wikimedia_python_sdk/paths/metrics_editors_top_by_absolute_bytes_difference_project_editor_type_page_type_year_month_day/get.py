...
from wikimedia_python_sdk.model.top_editors_by_abs_bytes_diff import TopEditorsByAbsBytesDiff as TopEditorsByAbsBytesDiffSchema
...
from wikimedia_python_sdk.type.top_editors_by_abs_bytes_diff import TopEditorsByAbsBytesDiff

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.top_editors_by_abs_bytes_diff import TopEditorsByAbsBytesDiff as TopEditorsByAbsBytesDiffPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = TopEditorsByAbsBytesDiffSchema
    ...
    async def _aget_top_by_absolute_bytes_difference_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/editors/top-by-absolute-bytes-difference/{project}/{editor-type}/{page-type}/{year}/{month}/{day}',
            headers=_headers,
        )
