...
from wikimedia_python_sdk.model.top_edited_pages_by_net_bytes_diff import TopEditedPagesByNetBytesDiff as TopEditedPagesByNetBytesDiffSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.top_edited_pages_by_net_bytes_diff import TopEditedPagesByNetBytesDiff

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.top_edited_pages_by_net_bytes_diff import TopEditedPagesByNetBytesDiff as TopEditedPagesByNetBytesDiffPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = TopEditedPagesByNetBytesDiffSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_top_by_net_bytes_difference_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_top_by_net_bytes_difference_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/edited-pages/top-by-net-bytes-difference/{project}/{editor-type}/{page-type}/{year}/{month}/{day}',
            headers=_headers,
        )
    ...
    def _get_top_by_net_bytes_difference_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTopByNetBytesDifferenceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_by_net_bytes_difference(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_top_by_net_bytes_difference_mapped_args(
            project=project,
        ...
        return await self._aget_top_by_net_bytes_difference_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_top_by_net_bytes_difference(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_top_by_net_bytes_difference_oapg(
            path_params=args.path,
        )

class GetTopByNetBytesDifference(BaseApi):
    ...
    async def aget_top_by_net_bytes_difference(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_top_by_net_bytes_difference(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            year=year,
    ...
    def get_top_by_net_bytes_difference(
        ...
        raw_response = self.raw.get_top_by_net_bytes_difference(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            year=year,
