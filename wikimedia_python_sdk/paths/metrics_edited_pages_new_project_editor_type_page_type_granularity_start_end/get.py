...
from wikimedia_python_sdk.model.new_pages import NewPages as NewPagesSchema
...
from wikimedia_python_sdk.type.new_pages import NewPages

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.new_pages import NewPages as NewPagesPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = NewPagesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_new_pages_counts_for_project_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_new_pages_counts_for_project_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/edited-pages/new/{project}/{editor-type}/{page-type}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_new_pages_counts_for_project_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetNewPagesCountsForProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_new_pages_counts_for_project(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_new_pages_counts_for_project_mapped_args(
            project=project,
        ...
        return await self._aget_new_pages_counts_for_project_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_new_pages_counts_for_project(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_new_pages_counts_for_project_oapg(
            path_params=args.path,
        )

class GetNewPagesCountsForProject(BaseApi):
    ...
    async def aget_new_pages_counts_for_project(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_new_pages_counts_for_project(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
    ...
    def get_new_pages_counts_for_project(
        ...
        raw_response = self.raw.get_new_pages_counts_for_project(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
