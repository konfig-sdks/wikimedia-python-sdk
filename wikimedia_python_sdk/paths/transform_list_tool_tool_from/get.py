...
class BaseApi(api_client.Api):
    ...
    def _tool_language_pairs_list_mapped_args(
        self,
        tool: str,
        _from: str,
    ...
    async def _atool_language_pairs_list_oapg(
        self,
    ...
    def _tool_language_pairs_list_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ToolLanguagePairsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atool_language_pairs_list(
        self,
        tool: str,
        _from: str,
        **kwargs,
        ...
        args = self._tool_language_pairs_list_mapped_args(
            tool=tool,
            _from=_from,
        )
        return await self._atool_language_pairs_list_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def tool_language_pairs_list(
        self,
        tool: str,
        _from: str,
    ) -> typing.Union[
        ...
        return self._tool_language_pairs_list_oapg(
            path_params=args.path,
        )

class ToolLanguagePairsList(BaseApi):
    ...
    async def atool_language_pairs_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atool_language_pairs_list(
            tool=tool,
            _from=_from,
            **kwargs,
        )
    ...
    def tool_language_pairs_list(
        ...
        raw_response = self.raw.tool_language_pairs_list(
            tool=tool,
            _from=_from,
        )
        if validate:
