...
from wikimedia_python_sdk.model.net_bytes_difference import NetBytesDifference as NetBytesDifferenceSchema
...
from wikimedia_python_sdk.type.net_bytes_difference import NetBytesDifference

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.net_bytes_difference import NetBytesDifference as NetBytesDifferencePydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = NetBytesDifferenceSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_net_aggregate_by_project_and_date_range_mapped_args(
        self,
        project: str,
        editor_type: str,
        page_type: str,
    ...
    async def _aget_net_aggregate_by_project_and_date_range_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/bytes-difference/net/aggregate/{project}/{editor-type}/{page-type}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_net_aggregate_by_project_and_date_range_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetNetAggregateByProjectAndDateRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_net_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        **kwargs,
        ...
        args = self._get_net_aggregate_by_project_and_date_range_mapped_args(
            project=project,
        ...
        return await self._aget_net_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_net_aggregate_by_project_and_date_range(
        self,
        project: str,
        editor_type: str,
        page_type: str,
        ...
        return self._get_net_aggregate_by_project_and_date_range_oapg(
            path_params=args.path,
        )

class GetNetAggregateByProjectAndDateRange(BaseApi):
    ...
    async def aget_net_aggregate_by_project_and_date_range(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_net_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
    ...
    def get_net_aggregate_by_project_and_date_range(
        ...
        raw_response = self.raw.get_net_aggregate_by_project_and_date_range(
            project=project,
            editor_type=editor_type,
            page_type=page_type,
            granularity=granularity,
