...
from wikimedia_python_sdk.model.unique_devices import UniqueDevices as UniqueDevicesSchema
...
from wikimedia_python_sdk.type.unique_devices import UniqueDevices

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.problem import Problem as ProblemPydantic
from wikimedia_python_sdk.pydantic.unique_devices import UniqueDevices as UniqueDevicesPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = UniqueDevicesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_project_and_date_range_mapped_args(
        self,
        project: str,
        access_site: str,
        granularity: str,
    ...
    async def _aget_by_project_and_date_range_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/unique-devices/{project}/{access-site}/{granularity}/{start}/{end}',
            headers=_headers,
        )
    ...
    def _get_by_project_and_date_range_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByProjectAndDateRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_project_and_date_range(
        self,
        project: str,
        access_site: str,
        granularity: str,
        ...
        **kwargs,
        ...
        args = self._get_by_project_and_date_range_mapped_args(
            project=project,
        ...
        return await self._aget_by_project_and_date_range_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_project_and_date_range(
        self,
        project: str,
        access_site: str,
        granularity: str,
        ...
        return self._get_by_project_and_date_range_oapg(
            path_params=args.path,
        )

class GetByProjectAndDateRange(BaseApi):
    ...
    async def aget_by_project_and_date_range(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_project_and_date_range(
            project=project,
            access_site=access_site,
            granularity=granularity,
            start=start,
    ...
    def get_by_project_and_date_range(
        ...
        raw_response = self.raw.get_by_project_and_date_range(
            project=project,
            access_site=access_site,
            granularity=granularity,
            start=start,
