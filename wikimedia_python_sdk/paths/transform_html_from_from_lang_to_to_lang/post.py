...
class BaseApi(api_client.Api):
    ...
    def _content_machine_translate_mapped_args(
        self,
        html: str,
        from_lang: str,
        to_lang: str,
    ...
    async def _acontent_machine_translate_oapg(
        self,
    ...
    def _content_machine_translate_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ContentMachineTranslateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontent_machine_translate(
        self,
        html: str,
        from_lang: str,
        to_lang: str,
        **kwargs,
        ...
        args = self._content_machine_translate_mapped_args(
            html=html,
            from_lang=from_lang,
            to_lang=to_lang,
        )
        return await self._acontent_machine_translate_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def content_machine_translate(
        self,
        html: str,
        from_lang: str,
        to_lang: str,
        ...
        return self._content_machine_translate_oapg(
            body=args.body,
            path_params=args.path,
        )

class ContentMachineTranslate(BaseApi):
    ...
    async def acontent_machine_translate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontent_machine_translate(
            html=html,
            from_lang=from_lang,
            to_lang=to_lang,
            **kwargs,
    ...
    def content_machine_translate(
        ...
        raw_response = self.raw.content_machine_translate(
            html=html,
            from_lang=from_lang,
            to_lang=to_lang,
        )
