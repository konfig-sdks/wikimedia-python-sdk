...
from wikimedia_python_sdk.model.pageview_article import PageviewArticle as PageviewArticleSchema

from wikimedia_python_sdk.type.pageview_article import PageviewArticle
from wikimedia_python_sdk.type.problem import Problem

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.pageview_article import PageviewArticle as PageviewArticlePydantic
...
class AgentSchema(
    ...
    def BOT(cls):
        return cls("bot")
ArticleSchema = schemas.StrSchema
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'agent': typing.Union[AgentSchema, str, ],
        'article': typing.Union[ArticleSchema, str, ],
...
request_path_agent = api_client.PathParameter(
    name="agent",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AgentSchema,
    required=True,
)
request_path_article = api_client.PathParameter(
    name="article",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationProblemjson = PageviewArticleSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_pageview_counts_by_article_date_range_mapped_args(
        self,
        project: str,
        access: str,
        agent: str,
    ...
    async def _aget_pageview_counts_by_article_date_range_oapg(
        self,
    ...
    def _get_pageview_counts_by_article_date_range_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPageviewCountsByArticleDateRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pageview_counts_by_article_date_range(
        self,
        project: str,
        access: str,
        agent: str,
        ...
        **kwargs,
        ...
        args = self._get_pageview_counts_by_article_date_range_mapped_args(
            project=project,
            access=access,
            agent=agent,
            article=article,
        ...
        return await self._aget_pageview_counts_by_article_date_range_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_pageview_counts_by_article_date_range(
        self,
        project: str,
        access: str,
        agent: str,
        ...
        return self._get_pageview_counts_by_article_date_range_oapg(
            path_params=args.path,
        )

class GetPageviewCountsByArticleDateRange(BaseApi):
    ...
    async def aget_pageview_counts_by_article_date_range(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pageview_counts_by_article_date_range(
            project=project,
            access=access,
            agent=agent,
            article=article,
    ...
    def get_pageview_counts_by_article_date_range(
        ...
        raw_response = self.raw.get_pageview_counts_by_article_date_range(
            project=project,
            access=access,
            agent=agent,
            article=article,
