...
from wikimedia_python_sdk.model.top_editors_by_net_bytes_diff import TopEditorsByNetBytesDiff as TopEditorsByNetBytesDiffSchema

from wikimedia_python_sdk.type.problem import Problem
from wikimedia_python_sdk.type.top_editors_by_net_bytes_diff import TopEditorsByNetBytesDiff

from ...api_client import Dictionary
from wikimedia_python_sdk.pydantic.top_editors_by_net_bytes_diff import TopEditorsByNetBytesDiff as TopEditorsByNetBytesDiffPydantic
...
SchemaFor200ResponseBodyApplicationProblemjson = TopEditorsByNetBytesDiffSchema
    ...
    async def _aget_top_by_net_bytes_difference_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/metrics/editors/top-by-net-bytes-difference/{project}/{editor-type}/{page-type}/{year}/{month}/{day}',
            headers=_headers,
        )
