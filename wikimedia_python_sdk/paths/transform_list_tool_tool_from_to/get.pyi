...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'tool': typing.Union[ToolSchema, str, ],
...
request_path_tool = api_client.PathParameter(
    name="tool",
...
class BaseApi(api_client.Api):
    ...
    def _tool_language_pairs_list_0_mapped_args(
        self,
        tool: str,
        _from: str,
        to: str,
    ...
    async def _atool_language_pairs_list_0_oapg(
        self,
    ...
    def _tool_language_pairs_list_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ToolLanguagePairsList0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atool_language_pairs_list_0(
        self,
        tool: str,
        _from: str,
        to: str,
        **kwargs,
        ...
        args = self._tool_language_pairs_list_0_mapped_args(
            tool=tool,
            _from=_from,
            to=to,
        )
        return await self._atool_language_pairs_list_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def tool_language_pairs_list_0(
        self,
        tool: str,
        _from: str,
        to: str,
        ...
        return self._tool_language_pairs_list_0_oapg(
            path_params=args.path,
        )

class ToolLanguagePairsList0(BaseApi):
    ...
    async def atool_language_pairs_list_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atool_language_pairs_list_0(
            tool=tool,
            _from=_from,
            to=to,
            **kwargs,
    ...
    def tool_language_pairs_list_0(
        ...
        raw_response = self.raw.tool_language_pairs_list_0(
            tool=tool,
            _from=_from,
            to=to,
        )
