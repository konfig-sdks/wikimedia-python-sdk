...
class BaseApi(api_client.Api):
    ...
    def _get_dictionary_meaning_mapped_args(
        self,
        from_lang: str,
        to_lang: str,
        word: str,
    ...
    async def _aget_dictionary_meaning_oapg(
        self,
    ...
    def _get_dictionary_meaning_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDictionaryMeaningRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_dictionary_meaning(
        self,
        from_lang: str,
        to_lang: str,
        word: str,
        **kwargs,
        ...
        args = self._get_dictionary_meaning_mapped_args(
            from_lang=from_lang,
            to_lang=to_lang,
            word=word,
        )
        return await self._aget_dictionary_meaning_oapg(
    ...
    def get_dictionary_meaning(
        ...
        return self._get_dictionary_meaning_oapg(
            path_params=args.path,
        )

class GetDictionaryMeaning(BaseApi):
    ...
    async def aget_dictionary_meaning(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_dictionary_meaning(
            from_lang=from_lang,
            to_lang=to_lang,
            word=word,
            **kwargs,
    ...
    def get_dictionary_meaning(
        ...
        raw_response = self.raw.get_dictionary_meaning(
            from_lang=from_lang,
            to_lang=to_lang,
            word=word,
        )
