            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["access", "agent", "article", "granularity", "project", "timestamp", "views", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access", "agent", "article", "granularity", "project", "timestamp", "views", ], str]):
