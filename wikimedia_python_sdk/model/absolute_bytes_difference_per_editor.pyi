...
class AbsoluteBytesDifferencePerEditor(
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    class items(
                                    ...
                                    class MetaOapg:
                                        ...
                                        class items(
                                            ...
                                            class MetaOapg:
                                                ...
                                                class properties:
                                                    abs_bytes_diff = schemas.Int64Schema
                                            ...
                                            @typing.overload
                                            def __getitem__(self, name: typing_extensions.Literal["abs_bytes_diff"]) -> MetaOapg.properties.abs_bytes_diff: ...
                                            ...
                                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["abs_bytes_diff", "timestamp", ], str]):
                                                # dict_instance[name] accessor
                                                return super().__getitem__(name)
                                            
                                            
                                            @typing.overload
                                            def get_item_oapg(self, name: typing_extensions.Literal["abs_bytes_diff"]) -> typing.Union[MetaOapg.properties.abs_bytes_diff, schemas.Unset]: ...
                                            ...
                                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["abs_bytes_diff", "timestamp", ], str]):
                                            ...
                                            def __new__(
                                                ...
                                                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                                                abs_bytes_diff: typing.Union[MetaOapg.properties.abs_bytes_diff, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["user-text"]) -> MetaOapg.properties.user_text: ...
                        
                        @typing.overload
                        def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                        
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["granularity", "page-type", "project", "results", "user-text", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["user-text"]) -> typing.Union[MetaOapg.properties.user_text, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["granularity", "page-type", "project", "results", "user-text", ], str]):
                            return super().get_item_oapg(name)
