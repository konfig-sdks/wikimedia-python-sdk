            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    class items(
                                    ...
                                    class MetaOapg:
                                        ...
                                        class items(
                                            ...
                                            class MetaOapg:
                                                ...
                                                class properties:
                                                    new_registered_users = schemas.Int32Schema
                                            ...
                                            @typing.overload
                                            def __getitem__(self, name: typing_extensions.Literal["new_registered_users"]) -> MetaOapg.properties.new_registered_users: ...
                                            ...
                                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["new_registered_users", "timestamp", ], str]):
                                                # dict_instance[name] accessor
                                                return super().__getitem__(name)
                                            
                                            
                                            @typing.overload
                                            def get_item_oapg(self, name: typing_extensions.Literal["new_registered_users"]) -> typing.Union[MetaOapg.properties.new_registered_users, schemas.Unset]: ...
                                            ...
                                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["new_registered_users", "timestamp", ], str]):
                                            ...
                                            def __new__(
                                                ...
                                                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                                                new_registered_users: typing.Union[MetaOapg.properties.new_registered_users, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["granularity", "project", "results", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["granularity", "project", "results", ], str]):
                            return super().get_item_oapg(name)
