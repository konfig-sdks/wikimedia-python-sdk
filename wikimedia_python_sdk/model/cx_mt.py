...
class CxMt(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contents", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contents", ], str]):
