                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                activity_level = schemas.StrSchema
                                    ...
                                    class MetaOapg:
                                        ...
                                        class items(
                                            ...
                                            class MetaOapg:
                                                ...
                                                class properties:
                                                    edited_pages = schemas.Int32Schema
                                            ...
                                            @typing.overload
                                            def __getitem__(self, name: typing_extensions.Literal["edited_pages"]) -> MetaOapg.properties.edited_pages: ...
                                            ...
                                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["edited_pages", "timestamp", ], str]):
                                                # dict_instance[name] accessor
                                                return super().__getitem__(name)
                                            
                                            
                                            @typing.overload
                                            def get_item_oapg(self, name: typing_extensions.Literal["edited_pages"]) -> typing.Union[MetaOapg.properties.edited_pages, schemas.Unset]: ...
                                            ...
                                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["edited_pages", "timestamp", ], str]):
                                            ...
                                            def __new__(
                                                ...
                                                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                                                edited_pages: typing.Union[MetaOapg.properties.edited_pages, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["activity-level"]) -> MetaOapg.properties.activity_level: ...
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["activity-level", "editor-type", "granularity", "page-type", "project", "results", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["activity-level"]) -> typing.Union[MetaOapg.properties.activity_level, schemas.Unset]: ...
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["activity-level", "editor-type", "granularity", "page-type", "project", "results", ], str]):
                            return super().get_item_oapg(name)
