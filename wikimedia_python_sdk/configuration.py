...
from wikimedia_python_sdk.exceptions_base import ApiValueError
from wikimedia_python_sdk.exceptions import ClientConfigurationError
...
conf = wikimedia_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://wikimedia.org/api/rest_v1" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if mediawiki_auth:
            self.api_key['mediawiki_auth'] = mediawiki_auth
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("wikimedia_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'mediawiki_auth' in self.api_key:
            auth['mediawiki_auth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'cookie',
